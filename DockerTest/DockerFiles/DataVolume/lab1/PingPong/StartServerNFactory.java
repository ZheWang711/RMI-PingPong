...
public class StartServerNFactory {
    ...
    private static Skeleton<PingServer> startServerSkeleton(){
        ...
        Skeleton<PingServer> serverSkeleton = new Skeleton(PingServer.class, server, new InetSocketAddress("pingserver" ,7002));
        try{
    ...
    private static Skeleton<PingServerFactory> startFact(){
        ...
        Skeleton<PingServerFactory> factorySkeleton = new Skeleton(PingServerFactory.class, factory, new InetSocketAddress("pingserver" ,7001));
        try{
